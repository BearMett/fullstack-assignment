...
const userSeeds: UserSeed[] = [
  { email: "admin@sangsang.com", name: "상상단 관리자", phone: "010-0000-0000", role: UserRole.ADMIN },
...
const applicationSeeds: ApplicationSeed[] = [
  ...
  // 3월 독서 모임
  { userName: "김지수", meetingTitle: "3월 독서 모임: 달러구트 꿈 백화점", motivation: "이 책 정말 읽고 싶었어요! 함께 이야기 나누고 싶습니다." },
  { userName: "박서연", meetingTitle: "3월 독서 모임: 달러구트 꿈 백화점", motivation: "친구 추천으로 알게 됐는데 같이 읽으면 더 재밌을 것 같아요." },
  { userName: "정하나", meetingTitle: "3월 독서 모임: 달러구트 꿈 백화점", motivation: "환상문학을 좋아해서 꼭 참여하고 싶습니다." },
  // 매일 기록 챌린지
  { userName: "이민호", meetingTitle: "매일 기록 챌린지 — 30일 일기", motivation: "글쓰기 습관을 기르고 싶어요." },
  // 2월 독서 모임: 아몬드
  { userName: "김지수", meetingTitle: "2월 독서 모임: 아몬드", motivation: "감성적인 책을 좋아해서 신청했어요.", status: ApplicationStatus.SELECTED },
  // 요가 & 명상 소모임
